  ...
  return (
    <>
      <button
        ...
        className="hidden h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-white/[0.035] text-white/45 transition hover:border-white/20 hover:bg-white/[0.055] hover:text-white/75 xl:inline-flex"
